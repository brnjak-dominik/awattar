...
l = [(float (price)), (float (price1))]
l1 = [(float (price1)), (float (price2))]
l2 = [(float (price2)), (float (price3))]
l3 = [(float (price3)), (float (price4))]
l4 = [(float (price4)), (float (price5))]
l5 = [(float (price5)), (float (price6))]
l6 = [(float (price6)), (float (price7))]
l7 = [(float (price7)), (float (price8))]
l8 = [(float (price8)), (float (price9))]
l9 = [(float (price9)), (float (price10))]
l10 = [(float (price10)), (float (price11))]
l11 = [(float (price11)), (float (price12))]
l12 = [(float (price12)), (float (price13))]
l13 = [(float (price13)), (float (price14))]
l14 = [(float (price14)), (float (price15))]
l15 = [(float (price15)), (float (price16))]
l16 = [(float (price16)), (float (price17))]
l17 = [(float (price17)), (float (price18))]
l18 = [(float (price18)), (float (price19))]
l19 = [(float (price19)), (float (price20))]
l20 = [(float (price20)), (float (price21))]
l21 = [(float (price21)), (float (price22))]
l22 = [(float (price22)), (float (price23))]
...
var = {m:'A', m1:'B', m2:'C', m3:'D', m4:'E', m5:'F', m6:'G', m7:'H', m8:'I', m9:'J', m10:'K', m11:'L', m12:'M', m13:'N', m14:'O', m15:'P', m16:'Q', m17:'R', m18:'S', m19:'T', m20:'U', m21:'V', m22:'W'}
